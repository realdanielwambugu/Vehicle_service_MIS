            ...
            <div class="w-11/12 h-48 m-0-auto mt-10">
                ...
                <div class="w-full bgColor-1 py-4">
                    ...
                    <form id="form" class="w-11/12 fx fx-j-btw m-0-auto txt-h-l"
                        action="appointment" method="post">
                        <div class="w-7/12">

                            <input type="hidden" name="user_id" value="<?= auth()->id() ?>">

                            <div class="w-11/12 fw-600 mb-2">
                                <label for="service" class="block py-2 fs-sm color-sec-600">Service Name</label>
                                <div class="bgColor-sec-200 py-2 px-2">
                                    <select class="w-full py-2 px-2 rounded b-color-sec-300 border-2
                                    focus:b-color-sec outline-0" name="service_id">

                                        <?php foreach (App\Models\Service::all() as $service): ?>
                            ...
                            <div class="w-11/12 fw-600 mb-2">
                                <label for="reg_no" class="block py-2 fs-sm color-sec-600">Vehicle Reg.NO</label>
                                <div class="bgColor-sec-200 py-2 px-2">
                                    <input class="w-full py-2 px-2 rounded b-color-sec-300 border-2
                                    focus:b-color-sec outline-0"
                                    type="text" name="vehicle_reg_no">
                                </div>
                            </div>

                            <div class="w-11/12 fw-600 mb-2">
                                <label for="brand" class="block py-2 fs-sm color-sec-600">Vehicle Brand</label>
                                <div class="bgColor-sec-200 py-2 px-2">
                                    <input class="w-full py-2 px-2 rounded b-color-sec-300 border-2
                                    focus:b-color-sec outline-0"
                                    type="text" name="vehicle_brand">
                                </div>
                            </div>

                            <div class="w-11/12 fw-600 mb-2">
                                <label for="model" class="block py-2 fs-sm color-sec-600">Vehicle Model</label>
                                <div class="bgColor-sec-200 py-2 px-2">
                                    <input class="w-full py-2 px-2 rounded b-color-sec-300 border-2
                                    focus:b-color-sec outline-0"
                        ...
                        <div class="w-6/12 pt-4">
                            ...
                            <div class="w-11/12 fw-600 mb-2">
                                <label for="date" class="block py-2 fs-sm color-sec-600">Service Date</label>
                                <div class="bgColor-sec-200 py-2 px-2">
                                    <input class="w-full py-2 px-2 rounded b-color-sec-300 border-2
                                    focus:b-color-sec outline-0"
                                    type="date" name="service_date">
                                </div>
                            </div>

                            <div class="w-11/12 fw-600 mb-2">
                                <label for="Time" class="block py-2 fs-sm color-sec-600">Service Time</label>
                                <div class="bgColor-sec-200 py-2 px-2">
                                    <input class="w-full py-2 px-2 rounded b-color-sec-300 border-2
                                    focus:b-color-sec outline-0"
                                    type="time" name="service_time">
                                </div>
                            </div>

                            <p id="response"  class="w-full txt-h-c pb-2"></p>
