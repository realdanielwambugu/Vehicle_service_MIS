        ...
        <div class="w-10/12">
            ...
            <div class="w-11/12 h-48 m-0-auto mt-10">
                ...
                <div class="fx fx-j-btw">
                    <h3 class="pb-5">
                       <i class="fa fa-wrench"></i> Services List
                    </h3>
                    <a href="/service" class="no-line">
                      <h4><i class="fa fa-plus"></i> Add New Service</43>
                    </a>
                </div>
                        ...
                        <table class="w-full table-auto bgColor-trans border-separate">
                            <thead>
                                <tr>
                                    ...
                                    <th class=" py-2 color-pri">Service Name</th>
                                    <th class=" py-2 color-pri">Average Charge</th>
                                    <th class=" py-2 color-pri">Added On Date</th>
                            ...
                            <tbody class="txt-h-c">
                                ...
                                <tr class="bgColor-1 border-0 shadow">
                                    ...
                                    <td class="py-1 color-sec-800 border-0"> <?= $service->id ?> </td>
                                    <td class="py-1 color-sec-800 border-0"> <?= $service->name ?> </td>
                                    <td class="py-1 color-sec-800 border-0"> <?= $service->charge ?></td>
                                    <td class="py-1 color-sec-800 border-0"> <?= $service->created_at ?> </td>
                                    <td class="px-2 py-1 color-pri">
                                        <a href="/service/<?= $service->id ?>" class="no-line">
                                            view details
                                        </a>
                                    </td>
                                </tr>
